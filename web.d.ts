...
declare namespace $ {
    class $bog_bot_model extends $mol_github_model {
        names(): string[];
        ask_multimodal(content: any): this;
        request_body(model: string): string;
    }
}
...
declare namespace $ {
	...
	type $mol_status__status_bog_bot_1 = $mol_type_enforce<
		ReturnType< $bog_bot['communication'] >
		,
		ReturnType< $mol_status['status'] >
	>
	type $mol_list__rows_bog_bot_2 = $mol_type_enforce<
		ReturnType< $bog_bot['messages'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_view__sub_bog_bot_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_image__uri_bog_bot_4 = $mol_type_enforce<
		ReturnType< $bog_bot['attached_image_uri'] >
		,
		ReturnType< $mol_image['uri'] >
	>
	type $mol_button_minor__hint_bog_bot_5 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_bog_bot_6 = $mol_type_enforce<
		ReturnType< $bog_bot['remove_image'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_bot_7 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_view__sub_bog_bot_8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_bot_9 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_bot_10 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_button_minor__hint_bog_bot_11 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_bog_bot_12 = $mol_type_enforce<
		ReturnType< $bog_bot['remove_audio'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_bot_13 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_view__sub_bog_bot_14 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_list__rows_bog_bot_15 = $mol_type_enforce<
		ReturnType< $bog_bot['attachments_preview'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_button_minor__hint_bog_bot_16 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_bog_bot_17 = $mol_type_enforce<
		ReturnType< $bog_bot['image_upload'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_bot_18 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_button_minor__hint_bog_bot_19 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_bog_bot_20 = $mol_type_enforce<
		ReturnType< $bog_bot['paste_screenshot'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_bot_21 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_view__sub_bog_bot_22 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_button_minor__hint_bog_bot_23 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__sub_bog_bot_24 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_row__sub_bog_bot_25 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_row['sub'] >
	>
	type $mol_textarea__hint_bog_bot_26 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_textarea['hint'] >
	>
	type $mol_textarea__value_bog_bot_27 = $mol_type_enforce<
		ReturnType< $bog_bot['prompt_text'] >
		,
		ReturnType< $mol_textarea['value'] >
	>
	type $mol_textarea__submit_bog_bot_28 = $mol_type_enforce<
		ReturnType< $bog_bot['prompt_submit'] >
		,
		ReturnType< $mol_textarea['submit'] >
	>
	type $mol_button_minor__hint_bog_bot_29 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_bog_bot_30 = $mol_type_enforce<
		ReturnType< $bog_bot['prompt_submit'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_bot_31 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $bog_bot_model__params_bog_bot_32 = $mol_type_enforce<
		({ 
			'temperature': number,
		}) 
		,
		ReturnType< $bog_bot_model['params'] >
	>
	type $bog_bot_model__rules_bog_bot_33 = $mol_type_enforce<
		ReturnType< $bog_bot['context'] >
		,
		ReturnType< $bog_bot_model['rules'] >
	>
	type $mol_page__body_content_bog_bot_34 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['body_content'] >
	>
	type $mol_page__foot_bog_bot_35 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['foot'] >
	>
	export class $bog_bot extends $gd_bot {
		rules( ): string
		context( ): ReturnType< $bog_bot['rules'] >
		communication( ): any
		Status( ): $mol_status
		messages( ): readonly(any)[]
		Messages( ): $mol_list
		Avatar( ): $mol_view
		attached_image_uri( id: any): string
		Attached_image( id: any): $mol_image
		remove_image( id: any): any
		Remove_image_icon( id: any): $mol_icon_close
		Remove_image( id: any): $mol_button_minor
		Attached_image_wrap( id: any): $mol_view
		Attached_audio_icon( id: any): $mol_icon_microphone
		Attached_audio_name( id: any): $mol_view
		Attached_audio( id: any): $mol_view
		remove_audio( id: any): any
		Remove_audio_icon( id: any): $mol_icon_close
		Remove_audio( id: any): $mol_button_minor
		Attached_audio_wrap( id: any): $mol_view
		attachments_preview( ): readonly(any)[]
		Attachments_preview( ): $mol_list
		image_upload( next?: any ): any
		Prompt_image_icon( ): $mol_icon_image
		Prompt_image_upload( ): $mol_button_minor
		paste_screenshot( next?: any ): any
		Prompt_paste_icon( ): $mol_icon_content_paste
		Prompt_paste( ): $mol_button_minor
		Prompt_audio_icon( ): $mol_icon_microphone
		Recording_indicator( ): $mol_view
		Prompt_audio_record( ): $mol_button_minor
		Prompt_attachments( ): $mol_row
		prompt_text( next?: string ): string
		prompt_submit( next?: any ): any
		Prompt_text( ): $mol_textarea
		Prompt_submit_icon( ): $mol_icon_send
		...
		Support( ): any
		Lights( ): any
		Model( next?: $bog_bot_model ): $bog_bot_model
		Dialog( ): $mol_page
	}
...
declare namespace $.$$ {
    ...
    export class $bog_bot extends $.$bog_bot {
        ...
        attached_images(next?: File[]): File[];
        attached_audio(next?: File[]): File[];
        media_recorder?: MediaRecorder;
        audio_chunks: Blob[];
        image_upload(): void;
        paste_screenshot(): Promise<void>;
        dom_tree(): Element;
        is_recording(next?: boolean): boolean;
        Prompt_audio_record(): $mol_button_minor;
        start_audio_recording(): Promise<void>;
        stop_audio_recording(): void;
        Recording_indicator(): $mol_view;
        ...
        remove_audio(index: number): void;
        build_multimodal_content(text: string): Promise<MultimodalContent[]>;
        communication(): void;
        prompt_submit(): void;
