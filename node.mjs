...
var $;
(function ($) {
    class $bog_bot_model extends $mol_github_model {
        names() {
            return [
                'openai/gpt-4o-mini',
            ];
        }
        ask_multimodal(content) {
            this.history([
                ...this.history(),
                {
                    role: "user",
    ...
    __decorate([
        $mol_memo.method
    ], $bog_bot_model.prototype, "names", null);
    __decorate([
        $mol_action
    ], $bog_bot_model.prototype, "ask_multimodal", null);
    __decorate([
        $mol_mem_key
    ], $bog_bot_model.prototype, "request_body", null);
    $.$bog_bot_model = $bog_bot_model;
})($ || ($ = {}));

;
	($.$bog_bot) = class $bog_bot extends ($.$gd_bot) {
		rules(){
			return "Ты - Гипер Бот, универсальный интеллектуальный ассистент. Пользователь присылает тебе запрос в виде JSON строки. Твоя задача сформировать максимально точный и лаконичный ответ на запрос без лишней информации, о которой пользователь не просил. Ответ должен быть представлен в виде JSON объекта, где в поле \"response\" должен находиться собственно ответ в виде строки. В поле \"confidence\" отрази степень своей увернности в истинности ответа в диапазоне от 0 до 1. В поле \"digest\" должен находиться краткий пересказ всего вашего диалога от начала до конца. Говоря о пользователе в пересказе (и только в нём) используй эмодзи 🙂 вместо слова \"пользователь\", а вместо \"Гипер Бота\" - используй эмозди 🤖. В поле \"title\" должно быть придумано лаконичное название, ёмко характеризующее всё обсуждение целиком. Отвечай всегда на языке с кодом {lang}, если пользователь не попросил иное. Далее идёт пересказ прошлых ваших сообщений, не потеряй его в своём пересказе. Ответ должен быть в формате json.";
		}
		context(){
			return (this.rules());
		}
		...
		attached_image_uri(id){
			return "";
		}
		Attached_image(id){
			const obj = new this.$.$mol_image();
			(obj.uri) = () => ((this.attached_image_uri(id)));
			return obj;
		}
		remove_image(id){
			return null;
		}
		Remove_image_icon(id){
			const obj = new this.$.$mol_icon_close();
			return obj;
		}
		Remove_image(id){
			const obj = new this.$.$mol_button_minor();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_bot_Remove_image_hint")));
			(obj.click) = (next) => ((this.remove_image(id)));
			(obj.sub) = () => ([(this.Remove_image_icon(id))]);
			return obj;
		}
		Attached_image_wrap(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Attached_image(id)), (this.Remove_image(id))]);
			return obj;
		}
		Attached_audio_icon(id){
			const obj = new this.$.$mol_icon_microphone();
			return obj;
		}
		Attached_audio_name(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([""]);
			return obj;
		}
		Attached_audio(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Attached_audio_icon(id)), (this.Attached_audio_name(id))]);
			return obj;
		}
		remove_audio(id){
			return null;
		}
		Remove_audio_icon(id){
			const obj = new this.$.$mol_icon_close();
			return obj;
		}
		Remove_audio(id){
			const obj = new this.$.$mol_button_minor();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_bot_Remove_audio_hint")));
			(obj.click) = (next) => ((this.remove_audio(id)));
			(obj.sub) = () => ([(this.Remove_audio_icon(id))]);
			return obj;
		}
		Attached_audio_wrap(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Attached_audio(id)), (this.Remove_audio(id))]);
			return obj;
		}
		attachments_preview(){
			return [(this.Attached_image_wrap(id)), (this.Attached_audio_wrap(id))];
		}
		Attachments_preview(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ((this.attachments_preview()));
			return obj;
		}
		image_upload(next){
			if(next !== undefined) return next;
		...
		Prompt_image_upload(){
			const obj = new this.$.$mol_button_minor();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_bot_Prompt_image_upload_hint")));
			(obj.click) = (next) => ((this.image_upload(next)));
			(obj.sub) = () => ([(this.Prompt_image_icon())]);
			return obj;
		}
		paste_screenshot(next){
			if(next !== undefined) return next;
			return null;
		}
		Prompt_paste_icon(){
		...
		Prompt_paste(){
			const obj = new this.$.$mol_button_minor();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_bot_Prompt_paste_hint")));
			(obj.click) = (next) => ((this.paste_screenshot(next)));
			(obj.sub) = () => ([(this.Prompt_paste_icon())]);
			return obj;
		}
		Prompt_audio_icon(){
			const obj = new this.$.$mol_icon_microphone();
		...
		Prompt_audio_record(){
			const obj = new this.$.$mol_button_minor();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_bot_Prompt_audio_record_hint")));
			(obj.sub) = () => ([(this.Prompt_audio_icon()), (this.Recording_indicator())]);
			return obj;
		}
		Prompt_attachments(){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([
				(this.Prompt_image_upload()), 
				(this.Prompt_paste()), 
				(this.Prompt_audio_record())
			]);
			return obj;
		}
		prompt_text(next){
		...
		Prompt_text(){
			const obj = new this.$.$mol_textarea();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_bot_Prompt_text_hint")));
			(obj.value) = (next) => ((this.prompt_text(next)));
			(obj.submit) = (next) => ((this.prompt_submit(next)));
			return obj;
		}
		...
		Prompt_submit(){
			const obj = new this.$.$mol_button_minor();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_bot_Prompt_submit_hint")));
			(obj.click) = (next) => ((this.prompt_submit(next)));
			(obj.sub) = () => ([(this.Prompt_submit_icon())]);
			return obj;
		}
		...
		Model(next){
			if(next !== undefined) return next;
			const obj = new this.$.$bog_bot_model();
			(obj.params) = () => ({"temperature": 0});
			(obj.rules) = () => ((this.context()));
			return obj;
		}
	...
	($mol_mem(($.$bog_bot.prototype), "Status"));
	($mol_mem(($.$bog_bot.prototype), "Messages"));
	($mol_mem(($.$bog_bot.prototype), "Avatar"));
	($mol_mem_key(($.$bog_bot.prototype), "Attached_image"));
	($mol_mem_key(($.$bog_bot.prototype), "Remove_image_icon"));
	($mol_mem_key(($.$bog_bot.prototype), "Remove_image"));
	($mol_mem_key(($.$bog_bot.prototype), "Attached_image_wrap"));
	($mol_mem_key(($.$bog_bot.prototype), "Attached_audio_icon"));
	($mol_mem_key(($.$bog_bot.prototype), "Attached_audio_name"));
	($mol_mem_key(($.$bog_bot.prototype), "Attached_audio"));
	($mol_mem_key(($.$bog_bot.prototype), "Remove_audio_icon"));
	($mol_mem_key(($.$bog_bot.prototype), "Remove_audio"));
	($mol_mem_key(($.$bog_bot.prototype), "Attached_audio_wrap"));
	($mol_mem(($.$bog_bot.prototype), "Attachments_preview"));
	($mol_mem(($.$bog_bot.prototype), "image_upload"));
	($mol_mem(($.$bog_bot.prototype), "Prompt_image_icon"));
	($mol_mem(($.$bog_bot.prototype), "Prompt_image_upload"));
	($mol_mem(($.$bog_bot.prototype), "paste_screenshot"));
	($mol_mem(($.$bog_bot.prototype), "Prompt_paste_icon"));
	($mol_mem(($.$bog_bot.prototype), "Prompt_paste"));
	($mol_mem(($.$bog_bot.prototype), "Prompt_audio_icon"));
	($mol_mem(($.$bog_bot.prototype), "Recording_indicator"));
	($mol_mem(($.$bog_bot.prototype), "Prompt_audio_record"));
	($mol_mem(($.$bog_bot.prototype), "Prompt_attachments"));
	($mol_mem(($.$bog_bot.prototype), "prompt_text"));
	($mol_mem(($.$bog_bot.prototype), "prompt_submit"));
	($mol_mem(($.$bog_bot.prototype), "Prompt_text"));
	($mol_mem(($.$bog_bot.prototype), "Prompt_submit_icon"));
	($mol_mem(($.$bog_bot.prototype), "Prompt_submit"));
	($mol_mem(($.$bog_bot.prototype), "Model"));
	($mol_mem(($.$bog_bot.prototype), "Dialog"));
...
(function ($) {
    ...
    (function ($$) {
        class $bog_bot extends $.$bog_bot {
            ...
            history(next) {
                if (next !== undefined) {
                    ...
                    const current = this.$.$mol_state_session.value('history') ?? $mol_maybe(this.$.$mol_state_arg.value('prompt') || null);
                    console.log('📖 history() READ called, length:', current.length);
                }
                return this.$.$mol_state_session.value('history', next) ?? $mol_maybe(this.$.$mol_state_arg.value('prompt') || null);
            }
            attached_images(next) {
                return next ?? [];
            }
            attached_audio(next) {
                return next ?? [];
            ...
            attached_image_uri(index) {
                const file = this.attached_images()[index];
                if (!file)
                    return '';
                return URL.createObjectURL(file);
            }
            attached_audio_name(index) {
            ...
            async build_multimodal_content(text) {
        ...
        __decorate([
            $mol_mem
        ], $bog_bot.prototype, "rules", null);
        __decorate([
            $mol_mem
        ], $bog_bot.prototype, "history", null);
        __decorate([
            $mol_mem
        ], $bog_bot.prototype, "attached_images", null);
        __decorate([
            $mol_mem
        ], $bog_bot.prototype, "attached_audio", null);
        __decorate([
            $mol_action
        ], $bog_bot.prototype, "image_upload", null);
        __decorate([
            $mol_action
        ], $bog_bot.prototype, "paste_screenshot", null);
        __decorate([
            $mol_mem
        ], $bog_bot.prototype, "is_recording", null);
        __decorate([
            $mol_mem
        ], $bog_bot.prototype, "Prompt_audio_record", null);
        __decorate([
            $mol_action
        ], $bog_bot.prototype, "start_audio_recording", null);
        __decorate([
            $mol_action
        ], $bog_bot.prototype, "stop_audio_recording", null);
        __decorate([
            $mol_mem
        ], $bog_bot.prototype, "Recording_indicator", null);
        __decorate([
            $mol_mem
        ], $bog_bot.prototype, "attachments_preview", null);
        __decorate([
            $mol_mem_key
        ], $bog_bot.prototype, "attached_image_uri", null);
        __decorate([
            $mol_mem_key
        ], $bog_bot.prototype, "attached_audio_name", null);
        __decorate([
            $mol_action
        ], $bog_bot.prototype, "remove_image", null);
        __decorate([
            $mol_action
        ], $bog_bot.prototype, "remove_audio", null);
        __decorate([
            $mol_mem
        ], $bog_bot.prototype, "communication", null);
        $$.$bog_bot = $bog_bot;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
